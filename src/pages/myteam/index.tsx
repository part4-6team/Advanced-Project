...
export default function MyTeamPage() {
  ...
  return memberships && memberships.length !== 0 ? (
    <main className="mx-auto mb-[30px] mt-[20px] flex w-full min-w-[340px] flex-col px-[20px] xl:w-[1200px] xl:px-0">
      ...
      <div className="grid h-full grid-cols-1 place-items-center gap-[15px] md:grid-cols-2 xl:grid-cols-3">
        ...
        <ClickMotion className="h-[80px] w-full rounded-[16px] border border-[#ffffff61] md:h-[100px]">
          <Link href="/addteam">
            <Button
              size="full"
              style={{ height: '100%' }}
